# integration/management/commands/sync_products.py
...
class Command(BaseCommand):
    help = 'Синхронизация товаров из МойСклад в сырые данные'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            for product_data in products:
                ...
                product, created = MoySkladProduct.objects.update_or_create(
